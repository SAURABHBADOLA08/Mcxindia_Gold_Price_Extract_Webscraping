...
class IMARC:
    ...
    def send_data(self):
        self.driver.find_element("xpath",'//*[@id="ctl00_cph_InnerContainerRight_C004_ddlSymbols_Arrow"]').click()
        self.driver.find_element("xpath",'//*[@id="ctl00_cph_InnerContainerRight_C004_ddlSymbols_DropDown"]/div/ul/li[18]').click()
        self.driver.find_element("xpath",'//*[@id="cph_InnerContainerRight_C004_ddlSession"]/option[3]').click()
        self.driver.find_element("xpath",'//*[@id="txtFromDate"]')
        time.sleep(2)
